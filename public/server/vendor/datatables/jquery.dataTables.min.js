...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": kích hoạt để sắp xếp cột tăng dần",sSortDescending:": kích hoạt để sắp xếp cột giảm dần"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Prev"},sEmptyTable:"Không có dữ liệu trong bảng",sInfo:"Hiển thị từ _START_ tới _END_ trong số _TOTAL_ mục",sInfoEmpty:"Hiển thị 0 tới 0 trong số 0 mục",
sInfoFiltered:"(được lọc từ _MAX_ mục)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Đang tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"Tìm kiếm...",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
